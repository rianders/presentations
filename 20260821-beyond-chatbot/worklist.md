...
**80 open items across 17 slides.**
...
## Slide 4 · AI INITIATIVE (ported from Mar 6 "AI Initiative")
...
## Slide 8 · YOUR COURSE MATERIALS AS CONTEXT (ported from Mar 6 "Materials")
...
## Slide 10 · ONE FOLDER, MANY MODELS
...
## Slide 12 · GEMS vs NOTEBOOK (new — both ground on your sources)
...
- [x] **Slide 9 — ASU sourced and corrected.** Arizona Republic, May 7 2026, linked on the
      slide. NOTE: the original framing ("exported to a third-party system") was wrong —
      ASU built the platform itself (ASU Atomic). Slide now states it accurately and
      includes ASU's response.
